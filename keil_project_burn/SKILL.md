...
```powershell
powershell -ExecutionPolicy Bypass -File "c:\Users\WLPC\.claude\skills\keil_project_burn\keil_burn.ps1" -Workspace "<工作目录>"
```
...
```powershell
powershell -ExecutionPolicy Bypass -File "c:\Users\WLPC\.claude\skills\keil_project_burn\keil_burn.ps1" -Workspace "<工作目录>" -BuildFirst
```
