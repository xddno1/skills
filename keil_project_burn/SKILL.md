...
```powershell
powershell -ExecutionPolicy Bypass -File "C:\Users\WLPC\.kimi-code\skills\keil_project_burn\keil_burn.ps1" -Workspace "<工作目录>"
```
...
```powershell
powershell -ExecutionPolicy Bypass -File "C:\Users\WLPC\.kimi-code\skills\keil_project_burn\keil_burn.ps1" -Workspace "<工作目录>" -BuildFirst
```
